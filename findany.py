...
class Keyword():
    ...
    def find(self):
        ...
        for tag in tags:
            # If start with h menas it is a link. http. Avoid menus or page structure links
            if tag['href'][0] == 'h':
                return tags
        return False

    # This method will be implemented in next version after code institute evaluation
